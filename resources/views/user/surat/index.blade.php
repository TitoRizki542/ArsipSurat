                                ...
                                <div class="col-lg-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control rounded-pill border-0" id="subject"
                                            placeholder="Cari Surat" name="cari" value="{{ request('cari') }}">
                                        <label for="subject">Cari Surat</label>
>>>>>>> f3aa7760e9228e548645898947517f074f06afdd
                                    </div>
                                </div>
...
=======
                                ...
                                <div class="col-lg-4">
                                    <div class="form-floating my-auto">
                                        <select class="form-select rounded-pill border-0" name="tag" onchange="this.form.submit()">
                                            <option value="">-- Pilih Nama Surat --</option>
                                            @foreach ($jenisSurat as $jenis)
                                            <option value="{{ $jenis->id }}" {{ request('tag') == $jenis->id ? 'selected' : '' }}>
                                                {{ $jenis->nama }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                {{-- Tombol Reset --}}
                                <div class="col-lg-2">
                                    <a href="{{ route('surat.index') }}" class="btn btn-sm btn-secondary w-100 py-3 rounded-pill">
                                        Reset
                                    </a>
>>>>>>> f3aa7760e9228e548645898947517f074f06afdd
                                </div>
