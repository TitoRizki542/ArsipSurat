                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="mt-2">
                                    <img src="{{ URL::asset('img') }}/logo.png" alt="dpm4kb" width="80px">
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2 text-center">Sistem Pengarsipan Surat</h4>
                        <p class="mb-4 text-center">Masukan Username dan Password untuk Login</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="form-check required">
                                    ...
                                    <label class="form-check-label" for="remember-me">Persetujuan Pengguna </label>
                                </div>
                            </div>
                            <div class="mb-3 mt-3">
                                <button class="btn btn-secondary d-grid w-100 rounded-pill"
