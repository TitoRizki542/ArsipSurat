                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <div class="d-flex gap-2">
                            <img src="{{ URL::asset('img') }}/logo.png" alt="" width="40px">
                            <h2 class="app-brand-text fw-bolder my-auto">DPM4KB</h2>
                        </div>
                        {{-- <span class="app-brand-text demo menu-text fw-bolder ms-2">DPM4KB
                        </span> --}}
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item ">
                        <a href="{{ route('arsip.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Arsipkan Surat</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                            <div data-i18n="Layouts">Surat Terarsip</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('surat.keluar') }}" class="menu-link">
                                    <div data-i18n="Without menu">Surat Keluar</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('semua.surat') }}" class="menu-link">
                                    <div data-i18n="Without menu">Surat Terarsip</div>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <marquee behavior="scroll" direction="left" loop="infinite">Sistem Pengarsipan Surat DPM4KB
                        </marquee>
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <span
                                                        class="fw-semibold d-block">{{ auth('admin')->user()->nama }}</span>
                ...
                <div class="content-wrapper">
                    <!-- Content -->
                    <div class="container">
                        <h3 class="mt-4">@yield('halaman')</h3>
                        @yield('content')
                    </div>
                </div>
                <!-- / Content -->
